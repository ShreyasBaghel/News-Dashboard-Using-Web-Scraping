...
__all__ = ['GoogleSqlLexer', 'PostgresLexer', 'PlPgsqlLexer',
           ...
           'TransactSqlLexer', 'MySqlLexer', 'databaseConsoleLexer', 'RqlLexer']

line_re  = re.compile('.*?\n')
database_prompt_re = re.compile(r'^(?:database|   ...)>(?= )')
...
class databaseConsoleLexer(Lexer):
    """
    Lexer for example sessions using database3.
    """

    name = 'database3con'
    aliases = ['database3']
    filenames = ['*.database3-console']
    mimetypes = ['text/x-database3-console']
    url = 'https://www.database.org'
    version_added = '0.11'
    _example = "database3/database3.database3-console"
    ...
    def get_tokens_unprocessed(self, data):
        ...
        for match in line_re.finditer(data):
            line = match.group()
            prompt_match = database_prompt_re.match(line)
