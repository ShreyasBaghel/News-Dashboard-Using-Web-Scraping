...
export default function DalmiaLogo({ height = '36px', ...props }) {
  return (
    <svg
      version="1.2"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1543 808"
      style={{ height, display: 'block', width: 'auto', ...props.style }}
      {...props}
    >
      <title>Dalmia Bharat Cement Logo</title>
      <defs>
        ...
        <linearGradient id="g1" x1="1105" y1="503.6" x2="1449.6" y2="366.4" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#959c98"/>
          <stop offset=".25" stopColor="#959c98"/>
          <stop offset=".347" stopColor="#9ea5a1"/>
          <stop offset=".507" stopColor="#b7bdba"/>
          <stop offset=".709" stopColor="#e0e3e2"/>
          <stop offset=".75" stopColor="#e9eceb"/>
          <stop offset=".904" stopColor="#f5f6f6"/>
        ...
        <linearGradient id="g2" x1="1117.7" y1="88.7" x2="1060.2" y2="451.6" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#00321e"/>
          <stop offset=".122" stopColor="#00582c"/>
          <stop offset=".25" stopColor="#00843d"/>
          <stop offset=".321" stopColor="#0b893c"/>
          <stop offset=".448" stopColor="#299539"/>
          <stop offset=".614" stopColor="#5aa934"/>
          <stop offset=".75" stopColor="#87bc2f"/>
          <stop offset=".782" stopColor="#93c243"/>
          <stop offset=".849" stopColor="#b0d377"/>
          <stop offset=".942" stopColor="#e0eec9"/>
          <stop offset="1" stopColor="#ffffff"/>
        </linearGradient>
